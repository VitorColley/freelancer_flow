class UserSkillsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @user_skill.update(user_skill_params)
        format.html { redirect_to @user_skill, notice: "User skill was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to user_skills_path, notice: "User skill was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def user_skill_params
      params.expect(user_skill: [ :user_id, :skill_id ])
    end
end
